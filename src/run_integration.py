...
task_plan = generate_task_list('../res/planning_p3.txt') # Must be a path to a text file
visualize_paths_from_pddl(task_plan, '../res/example2.png') # path_to_map_file should be a path to an image